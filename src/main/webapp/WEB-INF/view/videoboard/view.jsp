...
<script>
	...
	<c:if test="${!empty userInfo}">
		$.ajax({
			...
			type:'post',
			data : {userno:${userInfo.userno}, gno:gno, ono:ono, nested:nested, board_no:${data.video_board_no}, tablename:4, comment_no : comment_no, content:content, my_userno : ${data.userno}},
			success : function(res) {
				if (res.trim() == '1') {
