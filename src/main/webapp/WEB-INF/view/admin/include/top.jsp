	...
	<div class="header_inner">
		...
		<div id="menu">
  			<ul class="menu">
				...
				<li><a href="<%=request.getContextPath()%>/admin/product/index.do" class="parent"><span>커뮤니티</span></a></li>
				<li><a href="<%=request.getContextPath()%>/admin/board/index.do" class="parent"><span>고객지원</span></a>
				...
				<li><a href="<%=request.getContextPath()%>/admin/admin/index.do" class="parent"><span>갤러리</span></a></li>
				<li><a href="<%=request.getContextPath()%>/admin/admin/index.do" class="parent"><span>관리자 관리</span></a></li>
			</ul>
		</div>
		<!--//gnb-->
	</div>
