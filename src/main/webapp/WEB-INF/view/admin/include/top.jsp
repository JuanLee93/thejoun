...
<div id="header">
	<div class="header_inner">
		...
		<div class="util">
			<ul>
				<li class="frist"><a href="/thejoun/admin/member/index.do" onclick="">Home</a></li>
		...
		<div id="menu">
  			<ul class="menu">
				...
				<li><a href="<%=request.getContextPath()%>/admin/notice/index.do" class="parent"><span>고객지원</span></a>
					<div class="standard_left">
						<ul>
				...
				<li><a href="<%=request.getContextPath()%>/admin/loginInfo/index.do" class="parent"><span>로그인내역</span></a></li>
			</ul>
		</div>
		<!--//gnb-->
	</div>
