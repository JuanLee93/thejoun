				...
				<div class="con">
					...
					<div id="bbs">
						<div id="bread">
							...
							<div class="btn">
								<div class="btnRight">
									<a class="btns" style="cursor:pointer;" href="javascript:;" onclick="goSave();"><strong>등록</strong></a>
									<a class="btns" style="cursor:pointer;" href="javascript:;" onclick="history.back();"><strong>취소</strong></a>
								</div>
							</div>
							<!--//btn-->
						<!-- //search -->
