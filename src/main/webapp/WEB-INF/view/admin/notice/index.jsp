				...
				<div class="con">
					...
					<div id="bbs">
						<div id="blist">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0" summary="관리자 고객지원 공지사항 목록입니다.">
								<colgroup>
									<col class="w3" />
									<col class="w4" />
									<col class="" />
		                        ...
		                        <c:forEach var="vo" items="${list }" varStatus="status">
		                            <tr>
		                            	<td class="first"><input type="checkbox" name="no" id="no" value="${vo.notice_no}"/></td>
		                                <td>${(totCount-status.index) - ((noticeVo.page-1)*10) }</td>
		                                <td class="title" data-notice_no="${vo.notice_no }" style="cursor: pointer;">
		                                    ${vo.title }
		                                </td>
		                                <td class="writer">
		                                    ${vo.name }
