...
@ComponentScan(basePackages = {"main,admin,adminLog,util,freeboard,concernboard,comment,chat,user,like,videoboard,bookmark,imageboard,report,question,friends,friendsAdd,notice,announce"}) //하위 패키지 전부 스캔, 클래스를 뒤지면서 component anotation있나 스캔
